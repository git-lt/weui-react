...
var Input = _react2.default.createClass({
  ...
  renderSelect: function renderSelect(options) {
    ...
    return _react2.default.createElement(
      'select',
      (0, _extends3.default)({ className: 'weui-select' }, options),
      opts
    );
  },
  ...
  render: function render() {
    var _props2 = this.props,
        ...
        others = (0, _objectWithoutProperties3.default)(_props2, ['type', 'placeholder', 'label', 'name', 'readOnly', 'disabled', 'right', 'vcode', 'errorInput', 'showClear', 'labelAlign', 'autoComplete', 'maxLength', 'debounce', 'selectBefore', 'showWarnIcon', 'focusInput', 'className', 'children']);
    ...
    var clsWarp = (0, _classnames2.default)('weui-cell', (0, _defineProperty3.default)({
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        type !== 'select' && _react2.default.createElement('input', (0, _extends3.default)({ className: 'weui-input', ref: 'ipt',
