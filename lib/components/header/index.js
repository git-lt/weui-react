...
var Header = _react2.default.createClass({
  ...
  render: function render() {
    var _props = this.props,
        ...
        others = _objectWithoutProperties(_props, ['title', 'leftSlot', 'rightSlot', 'showBack', 'showHome', 'backText', 'children', 'className']);
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('div', { className: 'mt-header-ink-bar mainbackground' })
    );
  }
});
