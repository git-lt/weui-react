...
exports.toast = exports.dialog = exports.Message = undefined;
...
var Message = _react2.default.createClass({
  ...
  showDialog: function showDialog(e, options) {
    var t = typeof options === 'undefined' ? 'undefined' : (0, _typeof3.default)(options);
    ...
    this.setState({ dialog: (0, _extends3.default)({}, options) });
  },
  ...
  showToast: function showToast(e, options) {
    ...
    options.show = true;
    this.setState({ toast: (0, _extends3.default)({}, options) });
