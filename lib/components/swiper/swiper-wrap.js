...
var Swiper = _react2.default.createClass({
  ...
  renderDots: function renderDots(count) {
    ...
    var cls = (0, _classnames2.default)('mt-indicator', (_classNames = {}, _defineProperty(_classNames, 'mt-indicator-' + dotsPosition, true), _defineProperty(_classNames, dotsClass, dotsClass), _classNames));
  ...
  render: function render() {
    var _props3 = this.props,
        ...
        others = _objectWithoutProperties(_props3, ['list', 'showDots', 'children', 'className']);

    var height = this.state.height;
    var count = list.length;

    var cls = (0, _classnames2.default)('mt-slider', _defineProperty({}, className, className));

    return _react2.default.createElement(
      'div',
      _extends({ className: cls, ref: 'swiperWrap' }, others),
      _react2.default.createElement(
        'div',
