...
var Countdown = function (finalDate, option) {
  this.option = option || {}
  this.PRECISION = this.option.precision || 100 // 0.1 seconds, used to update the DOM
  this.interval = null
  this.offset = {}
...
var fns = {
  ...
  _dispatchEvent (eventName) {
    ...
    this.option[eventName] && this.option[eventName](event)
    this.option.tick && this.option.tick(event)
  }
}
